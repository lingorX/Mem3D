...
if resume_epoch != nEpochs:
    ...
    composed_transforms_tr = transforms.Compose([
        ...
        tr.FixedResize(resolutions={'crop_image': (512, 512), 'crop_gt': (512, 512), 'crop_scribble': (512, 512)},flagvals={'crop_image':cv2.INTER_LINEAR,'crop_gt':cv2.INTER_LINEAR,'crop_scribble':cv2.INTER_LINEAR}),
